...
class ValuesClient(CmsClient):
    async def create(self, values: dict, table_id: str, index: str = None, collection_position: int = None):
    ...
    async def retrieve(self, value_id: str, collection_position: int = None):
        async with aiohttp.ClientSession() as session:
    ...
    async def delete(self, value_id: str, collection_position: int = None):
        async with aiohttp.ClientSession() as session:
    ...
    async def copy(self, value_id: str, table_id: str, collection_position: int = None):
