...
class FieldsClient(CmsClient):
    async def create(self, field: dict, table: str, name: str, index: str = None, collection_position: int = None):
    ...
    async def retrieve(self, field_id: str, collection_position: int = None):
        async with aiohttp.ClientSession() as session:
    ...
    async def delete(self, field_id: str, collection_position: int = None):
        async with aiohttp.ClientSession() as session:
    ...
    async def copy(self, field_id: str, table_id: str, collection_position: int = None):
